...
use crate::domain::{models::Email, ports::EmailClient}; // Import domain-specific modules
...
#[cfg(test)]
mod tests {
    use crate::api::utils::constants::test;
    ...
    fn email() -> Email {
        Email::parse(SecretString::from(SafeEmail().fake::<String>())).unwrap()
    }
