...
use crate::{api::AppState, domain::ports::{BannedStore, TwoFACodeStore, UserStore}};
...
pub fn api_routes<S: UserStore, B: BannedStore, T: TwoFACodeStore>(app_state: AppState<S, B, T>) -> Router {
    let allowed_origins = [
